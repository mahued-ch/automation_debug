...
boton_okcancel = obtener_imagenes_por_clave("boton_okcancel")
...
clave_acceso_nueva = obtener_imagenes_por_clave("clave_acceso_nueva")
sap_easy_access = obtener_imagenes_por_clave("sap_easy_access")
